...
const WEAPON_STATS := {
	"broken_sword":    {"damage": 8,  "cooldown": 0.40, "rarity": "common",    "description": "A rusted relic. Barely sharp.", "icon": "res://assets/art/items/broken_sword.png"},
	"steel_dagger":    {"damage": 12, "cooldown": 0.30, "rarity": "common",    "description": "Merchant's gift. Light and lethal.", "icon": "res://assets/art/items/steel_dagger.png"},
	"captains_blade":  {"damage": 15, "cooldown": 0.50, "rarity": "uncommon",  "description": "A commander's weapon. Heavy but ruthless.", "icon": "res://assets/art/items/captains_blade.png"},
	"spirit_edge":     {"damage": 18, "cooldown": 0.35, "rarity": "uncommon",  "description": "Ghost-forged blade. Cuts ethereal and flesh alike.", "icon": "res://assets/art/items/steel_sword.png"},
	"crimson_edge":    {"damage": 22, "cooldown": 0.45, "rarity": "rare",      "description": "Fang officer's saber. Wickedly fast.", "icon": "res://assets/art/items/weapon_greatsword.png"},
	"wardens_halberd": {"damage": 28, "cooldown": 0.60, "rarity": "legendary", "description": "Gate Warden's polearm. Devastating reach.", "icon": "res://assets/art/items/weapon_staff.png"},
}
...
const ACHIEVEMENTS := {
	...
	"first_blood": {
		"name": "First Blood",
		"icon": "🗡",
		"badge_path": "res://assets/art/badges/first_blood.png",
	...
	"body_count_50": {
		"name": "Body Count",
		"icon": "💀",
		"badge_path": "res://assets/art/badges/body_count_50.png",
	...
	"body_count_200": {
		"name": "Massacre",
		"icon": "☠",
		"badge_path": "res://assets/art/badges/body_count_200.png",
	...
	"flawless_chapter": {
		"name": "Untouchable",
		"icon": "🛡",
		"badge_path": "res://assets/art/badges/flawless_chapter.png",
	...
	"first_step": {
		"name": "First Step",
		"icon": "👣",
		"badge_path": "res://assets/art/badges/first_step.png",
	...
	"half_way": {
		"name": "Halfway There",
		"icon": "🗺",
		"badge_path": "res://assets/art/badges/half_way.png",
	...
	"act2_reacher": {
		...
		"icon": "🏰",
		"badge_path": "res://assets/art/badges/act2_reacher.png",
	...
	"armory_3": {
		...
		"icon": "⚔",
		"badge_path": "res://assets/art/badges/armory_3.png",
	...
	"armory_all": {
		"name": "Living Arsenal",
		"icon": "🔧",
		"badge_path": "res://assets/art/badges/armory_all.png",
	...
	"bestiary_half": {
		...
		"icon": "📖",
		"badge_path": "res://assets/art/badges/bestiary_half.png",
	...
	"bestiary_all": {
		...
		"icon": "🎓",
		"badge_path": "res://assets/art/badges/bestiary_all.png",
	...
	"speed_demon": {
		"name": "Speed Demon",
		"icon": "⚡",
		"badge_path": "res://assets/art/badges/speed_demon.png",
	...
	"perfectionist": {
		"name": "Perfectionist",
		"icon": "💎",
		"badge_path": "res://assets/art/badges/perfectionist.png",
	...
	"legendary_find": {
		"name": "Jackpot",
		"icon": "🌟",
		"badge_path": "res://assets/art/badges/legendary_find.png",
	...
	"combo_master": {
		"name": "Combo King",
		"icon": "🔥",
		"badge_path": "res://assets/art/badges/combo_master.png",
	...
	"first_crit": {
		"name": "Critical Eye",
		"icon": "💫",
		"badge_path": "res://assets/art/badges/first_crit.png",
	...
	"crit_50": {
		...
		"icon": "🎯",
		"badge_path": "res://assets/art/badges/crit_50.png",
	...
	"enraged_kill": {
		...
		"icon": "😡",
		"badge_path": "res://assets/art/badges/enraged_kill.png",
	...
	"summon_slayer": {
		...
		"icon": "💀",
		"badge_path": "res://assets/art/badges/summon_slayer.png",
	...
	"streak_3": {
		"name": "Committed",
		"icon": "🔥",
		"badge_path": "res://assets/art/badges/streak_3.png",
	...
	"streak_7": {
		"name": "Unstoppable",
		"icon": "🔥",
		"badge_path": "res://assets/art/badges/streak_7.png",
	...
	"daily_challenger": {
		...
		"icon": "⚔",
		"badge_path": "res://assets/art/badges/daily_challenger.png",
	...
	"daily_veteran": {
		"name": "Daily Veteran",
		"icon": "🏅",
		"badge_path": "res://assets/art/badges/daily_veteran.png",
	...
	"ghost_hunter": {
		"name": "Ghost Hunter",
		"icon": "👻",
		"badge_path": "res://assets/art/badges/ghost_hunter.png",
	...
	"speed_demon_5": {
		"name": "Speed Demon",
		"icon": "⚡",
		"badge_path": "res://assets/art/badges/speed_demon_5.png",
